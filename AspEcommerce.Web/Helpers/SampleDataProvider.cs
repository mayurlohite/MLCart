...
namespace AspEcommerce.Web.Helpers
{
    public static class SampleDataProvider
    {
        ...
        public static void Seed(WebApplication app)
        {
            ...
            SeedAdminAccount(context).GetAwaiter().GetResult();
            SeedTestAccount(context).GetAwaiter().GetResult();
        ...
        #region TestDataSeed
        private static async Task TestDataSeed(ApplicationDbContext context)
        {
            #region RemoveRange
            ...
            {
                new BillingAddress { Id = BillingAddressIds.Billing0.GetGuid(), FirstName = "user", LastName = "aspcart", Email = "user@mayur.com", Address = "localhost", City = "localhost", StateProvince = "localhost", ZipPostalCode = "11234", Country = "localhost", Telephone = "0123456789" },
                new BillingAddress { Id = BillingAddressIds.Billing1.GetGuid(), FirstName = "user", LastName = "aspcart", Email = "user@mayur.com", Address = "localhost", City = "localhost", StateProvince = "localhost", ZipPostalCode = "11234", Country = "localhost", Telephone = "0123456789" },
                new BillingAddress { Id = BillingAddressIds.Billing2.GetGuid(), FirstName = "user", LastName = "aspcart", Email = "user@mayur.com", Address = "localhost", City = "localhost", StateProvince = "localhost", ZipPostalCode = "11234", Country = "localhost", Telephone = "0123456789" }
            };
        ...
        private static async Task SeedAdminAccount(ApplicationDbContext context)
        {
            ...
            var user = new ApplicationUser()
            {
                ...
                UserName = "admin@mayur.com",
                NormalizedUserName = "admin@mayur.com".ToUpper(),
                Email = "admin@mayur.com",
                NormalizedEmail = "admin@mayur.com".ToUpper(),
                EmailConfirmed = true,
            ...
            if (!context.Users.Any(u => u.UserName == user.UserName))
            {
                ...
                var hashed = passwordHasher.HashPassword(user, "Test@12345");
        ...
        private static async Task SeedTestAccount(ApplicationDbContext context)
        {
            // user1
            var user1 = new ApplicationUser()
            {
                Id = AccountIds.User1.GetGuid().ToString(),
                UserName = "user@mayur.com",
                NormalizedUserName = "user@mayur.com".ToUpper(),
                Email = "user@mayur.com",
                NormalizedEmail = "user@mayur.com".ToUpper(),
                EmailConfirmed = true,
                LockoutEnabled = false,
                SecurityStamp = Guid.NewGuid().ToString(),
            ...
            {
                var passwordHasher = new PasswordHasher<ApplicationUser>();
                var hashed = passwordHasher.HashPassword(user1, "Test@12345");
